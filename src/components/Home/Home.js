    ...
    return (
        <div className="mt-10">
            ...
            <div data-aos="fade-up"
                data-aos-duration="1000" data-aos-delay="300" data-aos-once="true" className="title-banner mx-8 sm:mx-12 md:mx-24 xl:mx-36 rounded-2xl flex flex-col lg:flex-row justify-between px-6 md:px-24 xl:px-32 py-8 mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6 md:gap-y-4 lg:grid-cols-3 gap-x-4 xl:gap-x-8 mx-8 sm:mx-12 md:mx-16 lg:mx-12 xl:mx-14 2xl:mx-20 mb-20">
                <Link data-aos="fade-up"
                    data-aos-duration="1000" data-aos-delay="500" data-aos-once="true" to="/product/digital">
                ...
                <Link data-aos="fade-up"
                    data-aos-duration="1000" data-aos-delay="1000" data-aos-once="true" to="/product/digital">
                ...
                <Link data-aos="fade-up"
                    data-aos-duration="1000" data-aos-delay="1500" data-aos-once="true" to="/product/digital" className="md:col-span-2 md:w-[50%] lg:w-full lg:mx-0 lg:col-span-1 md:mx-auto" >
            ...
            {/*new products */}
            <div data-aos="fade-up"
                data-aos-duration="800" data-aos-delay="500" data-aos-once="true" className="mx-4 sm:mx-12 md:mx-16 lg:mx-12 xl:mx-14 2xl:mx-20">
            ...
            {/*most sale products */}
            <div data-aos="fade-up"
                data-aos-duration="800" data-aos-delay="800" data-aos-once="true" className="flex relative z-0 overflow-hidden justify-between mx-8 sm:mx-12 md:mx-16 lg:mx-12 xl:mx-14 2xl:mx-20 clothes-banner rounded-xl px-6 py-8 mb-20">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-y-8 gap-x-8 mb-20 mx-8 sm:mx-12 md:mx-16 lg:mx-12 xl:mx-14 2xl:mx-20">
                <div data-aos="fade-up"
                    data-aos-duration="800" data-aos-delay="500" data-aos-once="true" className="bg-[#FF9AB3] pb-8 px-8 rounded-2xl">
                ...
                <div data-aos="fade-up"
                    data-aos-duration="800" data-aos-delay="1000" data-aos-once="true"  className="bg-[#648958] pb-8 px-8 rounded-2xl">
                    <div className="text-white text-[18px] lg:text-[16px] xl:text-[18px] mt-10 ">
                ...
                <div data-aos="fade-up"
                    data-aos-duration="800" data-aos-delay="1500" data-aos-once="true"  className="bg-[#EC8A3C] pb-8 px-8 rounded-2xl">
                    <div className="text-white text-[18px] lg:text-[16px] xl:text-[18px] mt-10 ">
                ...
                <div data-aos="fade-up"
                    data-aos-duration="800" data-aos-delay="2000" data-aos-once="true" className="bg-[#AF56C6] pb-8 px-8 rounded-2xl">
                    <div className="text-white text-[18px] lg:text-[16px] xl:text-[18px] mt-10 ">
            ...
            <div className="mx-8 justify-self-center sm:mx-12 md:mx-16 lg:mx-12 xl:mx-14 2xl:mx-20 flex flex-col sm:flex-row gap-x-14 mb-32">
                <div data-aos="fade-left"
                    data-aos-duration="1000" data-aos-delay="1500" data-aos-once="true" className="xl:relative relative sm:sticky top-0 mb-16 sm:mb-auto   sm:top-10 xl:top-0 mx-4 sm:mx-0 lg:mb-auto xl:my-auto max-w-max">
                ...
                <div data-aos="fade-right"
                    data-aos-duration="1000" data-aos-delay="1500" data-aos-once="true" className="grid lg:grid-cols-2 xl:grid-cols-3 gap-8">
